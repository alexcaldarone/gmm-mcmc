...
def build_model(model_type: str, 
    ...
    if model_type == "univariate":
        with pm.Model() as model:
            ...
            mu_k = pm.Normal("mu_k", mu=mu0, sigma=prior_params.muk_variance, shape=gmm_params.n_components)
        ...
        with pm.Model() as model:
            ...
            # Priors for component means and variances
            mu_k = pm.MvNormal("mu_k", mu = mu0, cov = prior_params.muk_variance, shape = (gmm_params.n_components, gmm_params.dimension))
